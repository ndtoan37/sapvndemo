...
/*!
 @brief     Returns the localized string suffix (e.g. "M", "K", etc.) to represent the magnitude of the value.  This is equivalent to calling `[[formatter setMagnitudeWithValue:value] magnitude]` but doesn't require a formatter object.
 */
+ (NSString *)magnitudeStringForValue:(double)value;
