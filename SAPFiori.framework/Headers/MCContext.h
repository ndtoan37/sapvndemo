...
/**
 ...
 The rect provided is normalized with respect to the bounds of the plot frame (so it doesn't take into account the locations of labels etc).
 */
...
float MCContextGetSelectedEndValuePosition(MCContextRef context);
void MCContextSetSelectedEndValuePosition(MCContextRef context, float position);
...
void MCContextSetSeriesAndValueIndices(MCContextRef context, short int series, short int startIndex, short int endIndex);
