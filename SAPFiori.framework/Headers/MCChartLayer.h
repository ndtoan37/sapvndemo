...
/**
 * Selection strategy that handles the selection logic.
 */
@property (nonatomic, retain) MCSelectionStrategy *selectionStrategy;
...
- (CGColorRef)chartLayer:(MCChartLayer *)chartLayer colorForSelection:(MCSelectionTouchTarget)touchTarget chartContext:(MCContextRef)chartContext;
@end
