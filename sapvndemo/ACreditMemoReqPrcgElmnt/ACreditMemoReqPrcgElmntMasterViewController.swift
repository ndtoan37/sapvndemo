//
// ACreditMemoReqPrcgElmntMasterViewController.swift
// sapvndemo
//
...
class ACreditMemoReqPrcgElmntMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [ACreditMemoReqPrcgElmntType] = [ACreditMemoReqPrcgElmntType]()
    private let logger = Logger.shared(named: "ACreditMemoReqPrcgElmntTypeMasterViewConterollerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let acreditmemoreqprcgelmnttype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CreditMemoRequest", value: "\(acreditmemoreqprcgelmnttype.creditMemoRequest!)")
        return cell
    }
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.apicreditmemorequestsrvEntities.fetchACreditMemoReqPrcgElmnt(matching: query) { aCreditMemoReqPrcgElmnt, error in
            guard let aCreditMemoReqPrcgElmnt = aCreditMemoReqPrcgElmnt else {
                completionHandler(error!)
                return
            }
            self.entities = aCreditMemoReqPrcgElmnt
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ACreditMemoReqPrcgElmntDetailViewController
...
extension ACreditMemoReqPrcgElmntMasterViewController: EntitySetUpdaterDelegate {
