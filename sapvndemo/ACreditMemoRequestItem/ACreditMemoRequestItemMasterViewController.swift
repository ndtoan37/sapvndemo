//
// ACreditMemoRequestItemMasterViewController.swift
// sapvndemo
//
...
class ACreditMemoRequestItemMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [ACreditMemoRequestItemType] = [ACreditMemoRequestItemType]()
    private let logger = Logger.shared(named: "ACreditMemoRequestItemTypeMasterViewConterollerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let acreditmemorequestitemtype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CreditMemoRequest", value: "\(acreditmemorequestitemtype.creditMemoRequest!)")
        return cell
    }
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.apicreditmemorequestsrvEntities.fetchACreditMemoRequestItem(matching: query) { aCreditMemoRequestItem, error in
            guard let aCreditMemoRequestItem = aCreditMemoRequestItem else {
                completionHandler(error!)
                return
            }
            self.entities = aCreditMemoRequestItem
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ACreditMemoRequestItemDetailViewController
...
extension ACreditMemoRequestItemMasterViewController: EntitySetUpdaterDelegate {
